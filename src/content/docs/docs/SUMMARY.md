...
* [users](users/README.md)
  ...
  * [Deposits](users/mainnet/index.md)
    * [Bridges](users/mainnet/bridges.md)
    * [Track Your Native Bitcoin Deposit](users/mainnet/track-your-native-bitcoin-deposit.md)
    * [Enclaves](users/mainnet/enclaves.md)
  * [Borrow](users/borrow/README.md)
    * [Overview](users/borrow/index.md)
    * [How to Borrow mUSDC](users/borrow/how-to-borrow-musdc.md)
    * [Borrow and Mint MUSD](users/borrow/mint-musd.md)
    * [Fees](users/borrow/fees.md)
    * [Architecture and Terminology](users/borrow/architecture-and-terminology.md)
    * [Liquidations & Redemptions](users/borrow/liquidation-mechanics.md)
    * [MUSD Bridge](users/borrow/musd-bridge.md)
  ...
  * [mezo-earn](users/mezo-earn/index.md)
    ...
    * [Lock](users/mezo-earn/lock/vebtc/index.md)
      ...
      * [veMEZO](users/mezo-earn/lock/vemezo/index.md)
        * [veMEZO Overview](users/mezo-earn/lock/vemezo/index.md)
        * [How to Lock MEZO](users/mezo-earn/lock/vemezo/how-to-lock-mezo.md)
        * [Boost Mechanism](users/mezo-earn/lock/vemezo/boost-mechanism.md)
        * [Matching Market](users/mezo-earn/lock/vemezo/matching-market.md)
        * [veMEZO FAQs and Resources](users/mezo-earn/lock/vemezo/faqs-and-resources.md)
    * [Vote](users/mezo-earn/vote/index.md)
      ...
      * [MEZO Gauges](users/mezo-earn/vote/mezo-gauges/index.md)
        * [MEZO Gauges Overview](users/mezo-earn/vote/mezo-gauges/index.md)
        * [How to Vote on MEZO Gauges](users/mezo-earn/vote/mezo-gauges/how-to-vote.md)
        * [Where Your Vote Goes](users/mezo-earn/vote/mezo-gauges/where-your-vote-goes.md)
        * [Claiming Incentives](users/mezo-earn/vote/mezo-gauges/claiming-incentives.md)
  ...
  * [integrations](users/integrations/README.md)
    * [Safe](users/integrations/safe.mdx)
      * [Overview](users/integrations/safe.mdx)
    ...
    * [Community Projects](users/integrations/community-projects.md)
  * [resources](users/resources/README.md)
    ...
    * [Glossary](users/resources/glossary.md)
