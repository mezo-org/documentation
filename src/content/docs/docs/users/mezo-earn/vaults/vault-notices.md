...
| **USDC Lending Vault**        | Deposit the supported USDC asset into a lending strategy.                                                           | Review the live rate, available withdrawal liquidity, strategist, and lending risks shown on the vault page.                                                    | [View USDC Lending Vault](https://mezo.org/earn/vaults/0x06291b67e3d7660240ab44Afc9a708d82b976a8B)       |
