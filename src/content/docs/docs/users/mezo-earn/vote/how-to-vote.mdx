...
- An active veBTC position (to vote on staking gauges)
...
veBTC holders vote on staking gauges to direct emissions and earn fees.
...
veMEZO holders vote on veBTC boost gauges to provide boost to BTC positions in exchange for incentives, and on [Mezo Gauges](/docs/users/mezo-earn/vote/mezo-gauges) to direct MEZO emissions to MUSD pools off Mezo. The two are independent — see [How to Vote on Mezo Gauges](/docs/users/mezo-earn/vote/mezo-gauges/how-to-vote) for that flow.
...
- [Mezo Gauges](/docs/users/mezo-earn/vote/mezo-gauges) — Vote with veMEZO to direct MEZO emissions to MUSD pools on Curve, Uniswap, and Aerodrome
