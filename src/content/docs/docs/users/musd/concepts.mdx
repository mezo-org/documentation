...
2. Alice opens loan , so the Alice's new loan has an interest rate of 3%
3. Governance sets the global interest rate to 6%.
4. Bob opens a loan , so Bob’s new loan has an interest rate of 6%.
...
1. Governance sets global interest rate at 3%.
2. Alice opens a loan , so Alice’s new loan has an interest rate of 3%.
3. Governance sets global interest rate at 6%.
4. Alice borrows MUSD.
...
2. Bob deposits 10k MUSD into SP. Alice now owns 2/3 of the SP and Bob owns 1/3 of the SP. The SP has 30k MUSD and 0 BTC.
3. Carol is liquidated for 5k MUSD. 5400 USD worth of BTC from the collateral goes to the SP. The SP has now 25k MUSD and 5400 USD worth of BTC.
4. Alice leaves the LP with 2/3 of the SP shares. Alice profits with a return calculated by the following equation:
