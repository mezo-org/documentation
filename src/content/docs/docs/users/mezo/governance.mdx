...
- **BTC-anchored voting** — Only veBTC holders can vote on governance proposals. veMEZO boosts veBTC voting power but grants no governance rights of its own. veMEZO does vote independently on [veBTC boost gauges](/docs/users/mezo-earn/lock/vemezo/matching-market) and [Mezo Gauges](/docs/users/mezo-earn/vote/mezo-gauges), which direct emissions rather than set protocol parameters.
