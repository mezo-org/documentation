...
- Mezo Bridge Service Fee: ≈ $3 USD (per token equivalent)
...
- tBTC Bridge Service Fee: 0.2% (of bridge amount minus Mezo Bridge Service Fee)
- tBTC Bridge Maximum Network Fee: up to 0.001 BTC (usually < $1)

Example:

Withdrawing 1 BTC → 0.000027 BTC (Mezo Bridge Service Fee) + 0.001999946 BTC (tBTC Bridge Service Fee) + variable tBTC Bridge Network Fee and Gas Fee  → receive ~0.997973 BTC.
