---
title: Using Mezo — Earn, Spend, and Save
description: Practical ways to use your Bitcoin and MUSD on Mezo — borrow, spend, swap, and earn.
topic: users
---
...
- Minimum $2,000 [MUSD](/docs/users/musd) borrow amount
- You must maintain at least 110% collateralization (to borrow $1,000 MUSD, you need $1,100 worth of BTC)

How to Borrow:

1. Go to mezo.org/borrow and [connect your wallet](/docs/users/getting-started/connect)
...
See also: [Borrow and Mint MUSD](/docs/users/musd/mint-musd).
...
For more about trading on Mezo, see [Mezo Swap](/docs/users/features/mezo-swap).
...
For insights on liquidity and trading pairs, visit [Mezo Pools](/docs/users/features/mezo-pools/mezo-pools).
