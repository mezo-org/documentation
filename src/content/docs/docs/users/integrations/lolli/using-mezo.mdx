...
3. Review your loan terms:
   ...
   * Liquidation price
   * Fees: 0.5% issuance fee + 200 MUSD gas deposit (returned when closed)
...
Monitor your collateral ratio at mezo.org/borrow. If BTC price drops, your ratio decreases—keep it above 110% to avoid liquidation. To close your loan, return to mezo.org/borrow, click "Repay," repay the full MUSD amount plus accumulated interest, and confirm. Your BTC collateral and 200 MUSD gas deposit are returned.
