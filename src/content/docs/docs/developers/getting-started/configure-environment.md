...
Configure your Hardhat or Foundry development environment for Mezo matsnet. 

## Before you begin

Before you can deploy applications, you will need an Ethereum wallet with matsnet BTC to pay for the gas fees.

* [Connect to Mezo matsnet](/docs/users/getting-started/mezo-matsnet-alpha-testnet/connect-to-mezo-matsnet)
* [Stack matsnet BTC](/docs/users/getting-started/mezo-matsnet-alpha-testnet/stack-matsnet-btc)
