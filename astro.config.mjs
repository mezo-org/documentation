	...
	integrations: [
		...
		starlight({
			...
			head: [
				...
				{
				  tag: 'script',
				  content: `(function(){try{var t=document.title||'Mezo Documentation';var d=(document.querySelector('meta[name="description"]')||{}).content||'';var u=location.origin+location.pathname;var orgLogo='https://raw.githubusercontent.com/mezo-org/documentation/main/src/assets/Mezo-Mark-Red.svg';var web={"@context":"https://schema.org","@type":["WebPage","TechArticle"],"headline":t,"name":t,"description":d,"url":u,"publisher":{"@type":"Organization","name":"Mezo","logo":{"@type":"ImageObject","url":orgLogo},"sameAs":["https://github.com/mezo-org","https://x.com/MezoNetwork","https://discord.mezo.org"]}};var s=document.createElement('script');s.type='application/ld+json';s.textContent=JSON.stringify(web);document.head.appendChild(s);var parts=location.pathname.replace(/\/$/,'').split('/').filter(Boolean);if(parts.length){var map={docs:'Documentation',users:'User Documentation',developers:'Developer Documentation',mainnet:'Mainnet',musd:'MUSD',features:'Features',resources:'Resources','getting-started':'Getting Started',introduction:'Introduction',bridge:'Bridge','stbtc-staked-bitcoin':'stBTC',architecture:'Architecture',oracles:'Oracles'};var items=[];var acc='';for(var i=0;i<parts.length;i++){var seg=parts[i];acc+='/'+seg;var isLast=i===parts.length-1;var name=isLast?t:(map[seg]||seg.replace(/-/g,' '));items.push({"@type":"ListItem",position:i+1,name:name,item:location.origin+acc+'/'});}var crumb={"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":items};var s2=document.createElement('script');s2.type='application/ld+json';s2.textContent=JSON.stringify(crumb);document.head.appendChild(s2);}}catch(e){}})();`
				}
			],
