	...
	integrations: [
		starlight({
			...
			locales: {
				...
				'docs/zh': { label: '中文', lang: 'zh' },
				'docs/in': { label: 'हिन्दी', lang: 'hi' },
				'docs/ru': { label: 'Русский', lang: 'ru' },
				'docs/ua': { label: 'Українська', lang: 'uk' },
				'docs/fr': { label: 'Français', lang: 'fr' },
				'docs/pt-br': { label: 'Português (Brasil)', lang: 'pt-BR' },
				'docs/kr': { label: '한국어', lang: 'ko' },
				'docs/vn': { label: 'Tiếng Việt', lang: 'vi' },
				'docs/de': { label: 'Deutsch', lang: 'de' },
				'docs/nl': { label: 'Nederlands', lang: 'nl' },
				'docs/es': { label: 'Español', lang: 'es' },
			},
			components: {
